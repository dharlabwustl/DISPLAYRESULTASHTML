...
write_text(htmlfile,"a","var div0_table = document.createElement('div');")
write_text(htmlfile,"a","var div1_table = document.createElement('div');")
write_text(htmlfile,"a","var div2_table = document.createElement('div');")
write_text(htmlfile,"a","var div3_table = document.createElement('div');")
write_text(htmlfile,"a","zeroRow0.appendChild(div0_table);")
write_text(htmlfile,"a","zeroRow1.appendChild(div1_table);")
write_text(htmlfile,"a","zeroRow2.appendChild(div2_table);")
write_text(htmlfile,"a","zeroRow3.appendChild(div3_table);")
write_text(htmlfile,"a","function filltable() {")
write_text(htmlfile,"a","div0_table.textContent=ATUL;")
write_text(htmlfile,"a","div1_table.textContent=ATUL;")
write_text(htmlfile,"a","div2_table.textContent=ATUL;")
write_text(htmlfile,"a","div3_table.textContent=ATUL;")
